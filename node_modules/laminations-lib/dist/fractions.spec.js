...
const equals = fractions_1.Fractions.equals;
describe('NaryFraction', () => {
    const binary = fractions_1.Fractions.parseFactory(2);
    const ternary = fractions_1.Fractions.parseFactory(3);
    const quaternary = fractions_1.Fractions.parseFactory(4);
    const decimal = fractions_1.Fractions.parseFactory(10);
    const dozenal = fractions_1.Fractions.parseFactory(12);
    ...
    it('supports less-than', () => {
        const lessThan = fractions_1.Fractions.lessThan;
    ...
    it('supports indexing', () => {
        const digitAt = fractions_1.Fractions.digitAt;
        const a = ternary('102_');
    ...
    it('simplifies fractions', () => {
        const f = (x, y) => fractions_1.Fractions.simplify(immutable_1.List(x), immutable_1.List(y)).map(list => list.toArray());
    ...
    it('converts to rational numbers', () => {
        const toRational = fractions_1.Fractions.toRational;
    ...
    it('supports a forward map', () => {
        const mapForward = fractions_1.Fractions.mapForward;
        expect(equals(mapForward(ternary('_')), ternary('_'))).toBe(true);
        expect(equals(mapForward(ternary('_012')), ternary('_120'))).toBe(true);
        expect(equals(mapForward(ternary('1_12')), ternary('_12'))).toBe(true);
        expect(equals(mapForward(ternary('12_')), mapForward(binary('_01')))).toBe(true);
    });
    it('supports a backwards map', () => {
        expect(fractions_1.Fractions.mapBackward(ternary('_01')).map(fractions_1.Fractions.toString).toArray())
            .toEqual([
            '0_01',
            '_10',
            '2_01'
    ...
    it('supports parsing string input', () => {
        const rawTernary = fractions_1.Fractions.fromArraysFactory(3);
        const rawDozenal = fractions_1.Fractions.fromArraysFactory(12);
...
describe('findCircularRepeatingSuffix', () => {
    const f = (x, y) => fractions_1.Fractions.findCircularRepeatingSuffix(immutable_1.List(x), immutable_1.List(y));
...
describe('reduceCircularSequence', () => {
    const f = x => fractions_1.Fractions.reduceCircularSequence(immutable_1.List(x)).toArray();
    it('works', () => {
        expect(f([])).toEqual([]);
        expect(f([3, 3, 3])).toEqual([3]);
...
describe('makeKMPFailureTable', () => {
    const f = fractions_1.Fractions.makeKMPFailureTable;
    it('works', () => {
        expect(f(immutable_1.List([1, 2, 1, 1, 2, 1, 1, 2, 1]))).toEqual(immutable_1.List([0, 0, 1, 1, 2, 3, 4, 5, 6]));
    });
});
describe('findNaturalSuffixStart', () => {
    const f = fractions_1.Fractions.findNaturalSuffixStart;
    it('works', () => {
        expect(f(immutable_1.List([1, 0, 1, 1, 2, 3, 4, 5]))).toEqual(3);
        expect(f(immutable_1.List([1, 0, 1, 1]))).toEqual(3);
        expect(f(immutable_1.List([1, 0, 1]))).toEqual(2);
        expect(f(immutable_1.List([0, 2, 3, 2]))).toEqual(4);
        expect(f(immutable_1.List([]))).toEqual(0);
    });
});
//# sourceMappingURL=fractions.spec.js.map